package com.yunlong.frame.security.compontent;
...
//		RequestMappingHandlerMapping mapping = BeanUtil.toBean("requestMappingHandlerMapping",
//				RequestMappingHandlerMapping.class);
