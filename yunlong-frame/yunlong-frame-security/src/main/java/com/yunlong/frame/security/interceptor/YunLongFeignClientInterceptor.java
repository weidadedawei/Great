 ...
 */
@Slf4j
public class YunLongFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public YunLongFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
