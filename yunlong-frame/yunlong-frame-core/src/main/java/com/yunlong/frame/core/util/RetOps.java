...
public class RetOps<T> {
     ...
     * 状态码为成功
     */
    public static final Predicate<R<?>> CODE_SUCCESS = r -> WebConstants.SUCCESS == r.getCode();
     ...
     *
     * @return 返回ture表示成功
     * @see WebConstants#SUCCESS
     */
    public boolean isSuccess() {
        return codeEquals(WebConstants.SUCCESS);
    }
    ...
    public <Ex extends Exception> RetOps<T> assertSuccess(Function<? super R<T>, ? extends Ex> func) throws Ex {
        return assertCode(WebConstants.SUCCESS, func);
    }
